  ...
  return (
    <div style={{backgroundColor: `${navBg}`}} className={shadow? 'fixed w-full h-20 shadow-xl z-[100]': 'fixed w-full h-20 z-[100]'}>
        <div className='flex justify-between  items-center w-full h-full px-2 2xl:px-16'>
            <Image src='/../public/assets/navLogo.png' alt='image'  width={70} height={50}/>
            ...
            nav
              ...
              : 'fixed left-[-100%] top-0 p-10 ease-in duration-500'
                ...
                <div>
                    ...
                    <Image src='/../public/assets/navLogo.png' alt='/' width='70' height='50'/>
                        <div onClick={handleNav}className='rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer'>
                            <AiOutlineClose/>
                        </div>
                    </div>
                    <div className ='border-b border-t-gray-300 my-4'>
                        <p className ='w-[85%] md:w-[90%] py-4'>Lets build somthing legendary together</p>
                    </div>
                </div>
